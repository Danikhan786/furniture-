                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="€{{ number_format($order->subtotal, 2) }}" disabled>
                                            </div>
                                            @if($order->coupon_code)
                                            <div class="form-group">
                                                <label>Coupon Code</label>
                                                <input type="text" class="form-control" value="{{ $order->coupon_code }} ({{ $order->coupon_discount }}% OFF)" disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Discount Amount</label>
                                                <input type="text" class="form-control text-success" value="-€{{ number_format($order->discount_amount, 2) }}" disabled>
                                            </div>
                                            @endif
                                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="state_country">State / Country <span class="text-danger">*</span></label>
                                                <input type="text" 
