    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                ...
                <a class="navbar-brand brand-logo text-white" href="{{ route('admin.dashboard') }}"><h1>Oasis Meubles</h1></a>
                <!-- <a class="navbar-brand brand-logo-mini" href="{{ route('admin.dashboard') }}"><img
                        src="../../../backend/assets/images/logo-mini.svg" alt="logo" /></a> -->
                <a class="navbar-brand brand-logo-mini text-white" href="{{ route('admin.dashboard') }}"><h1>OM</h1></a>
            </div>
